...
if CUDA_SIMULATION:
    ...
    def compile_kernel_specialization(dispatcher: Any, args: Tuple) -> None:
        ...
        _allow_opt_in_dynamic_shared(dispatcher)
...
def _allow_opt_in_dynamic_shared(dispatcher: Any) -> None:
    """Raise the kernel's dynamic shared limit to the opt-in maximum."""
